 ...
 * @noSelf
 */
declare interface LuaMatrixRow<TKey extends AnyNotNil = AnyNotNil, TValue = any> extends LuaPairsIterable<TKey, TValue> {
    [1]: number;
    [2]: number;
    [3]: number;
    [4]: number;
...
export declare function getElementMatrix(
    this: void,
    theElement: Element | MTASAObject,
    legacy?: boolean,
): LuaMatrix;
...
export declare function getElementsByType<T>(
    this: void,
    theType: string,
    startat?: Element,
    streamedIn?: boolean,
